...
def dashboards(request):
    ...
    return render(request, 'dashboard/dashboard.html', {'tasks': tasks, 'overdue_tasks': overdue_tasks})
...
def search_dashboards(request):
    try:
        ...
        overdue_tasks = tasks.filter(due_date__lt=today, status__in=['todo', 'in_progress'])
